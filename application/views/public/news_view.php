	...
	<div class="container">
		<div class="header-content">
			<div class="logo">
				...
				<span>News<span style="margin-inline-start: 3px" class="text-red">Grid</span></span>
			</div>
			<nav>
					...
					<?php foreach ($articles as $article) : ?>
						<div class="article">
							<img src="<?= base_url('upload/thumbnail/' . $article->thumbnail); ?>"
								 alt="<?= $article->post_title; ?>" width="100%">
							<div class="article-content">
								<h3>
									<a href="<?= site_url('home/detail/' . $article->id); ?>"><?= $article->post_title; ?></a>
								</h3>
